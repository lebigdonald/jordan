...
import { Code2, Menu, X, ArrowRight, CheckCircle2, Users, Zap, Shield, Mail, Phone, MapPin, Globe, Award, Clock } from 'lucide-react';
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <h1 className="text-5xl md:text-6xl font-bold text-slate-900 leading-tight">
                ...
                <span className="bg-gradient-to-r from-emerald-600 to-teal-600 bg-clip-text text-transparent"> Built in Africa</span>
              </h1>
              <p className="text-xl text-slate-600 leading-relaxed">
                Senior Full Stack Developer with 7+ years building scalable web and cloud applications for international companies. From San Francisco to London to Berlin, delivering excellence remotely from Cameroon.
              </p>
      ...
      <section id="services" className="py-20 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <span className="text-emerald-600 font-semibold text-sm uppercase tracking-wide">Core Expertise</span>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-slate-600 mb-8 leading-relaxed">
                7+ years of experience building scalable applications for companies across USA, UK, and Europe. Combining technical expertise with remote-first collaboration practices.
              </p>
            ...
            <div className="grid md:grid-cols-2 gap-12">
              <div>
                ...
                <p className="text-xl text-emerald-50 mb-8 leading-relaxed">
                  Ready to bring your project to life? Whether you need a full-stack developer, cloud architect, or technical consultant, I'm here to help.
                </p>
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <div className="space-y-2 text-slate-400">
                ...
                <div className="hover:text-emerald-400 transition-colors cursor-pointer">GitHub Projects</div>
                <div className="hover:text-emerald-400 transition-colors cursor-pointer">Certifications</div>
              </div>
            </div>
          </div>
